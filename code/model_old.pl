...
% Multi-face emotion aggregation (considers ALL faces (I think?))
...
t(_)::scene_emotion_boost(3, joy). % Happy emotion + joy place
t(_)::scene_emotion_boost(4, sad). % Sad emotion + sad place   
t(_)::scene_emotion_boost(6, neutral). % Neutral emotion + neutral place 
t(_)::scene_emotion_boost(3, sad). % Happy emotion + sad place
t(_)::scene_emotion_boost(4, joy). % Sad emotion + joy place
t(_)::scene_emotion_boost(_, neutral). % Any emotion + neutral place
