...
scene_prior(atrium_public, 4.45, 3.62).
...
scene_prior(bank_vault, 4.71, 0.26).
scene_prior(banquet_hall, 3.86, 2.6).
scene_prior(bar, 3.34, 3.18).
scene_prior(barn, 1.39, 4.52).
...
scene_prior(bathroom, 5.63, 4.38).
...
scene_prior(boathouse, 5.32, 0.57).
...
scene_prior(building_facade, 4.31, 1.8).
scene_prior(bullring, 2.8, 3.35).
scene_prior(burial_chamber, 0.71, 3.07).
...
scene_prior(corridor, 2.79, 0.71).
scene_prior(cottage, 4.01, 1.21).
...
scene_prior(diner_outdoor, 4.24, 2.33).
...
scene_prior(elevator_shaft, 5.21, 0.45).
...
scene_prior(fastfood_restaurant, 5.26, 3.12).
scene_prior(field_cultivated, 3.57, 1.57).
scene_prior(field_wild, 5.94, 1.89).
...
scene_prior(greenhouse_outdoor, 4.23, 1.95).
...
scene_prior(iceberg, 1.88, 1.92).
scene_prior(igloo, 4.09, 3.64).
scene_prior(industrial_area, 4.9, 4.31).
scene_prior(inn_outdoor, 6.0, 6.0).
scene_prior(islet, 3.83, 5.78).
...
scene_prior(manufactured_home, 2.78, 1.36).
...
scene_prior(office_building, 5.86, 5.54).
...
scene_prior(pantry, 4.8, 4.75).
scene_prior(park, 3.82, 2.89).
scene_prior(parking_garage_indoor, 4.0, 2.0).
scene_prior(parking_garage_outdoor, 3.63, 4.55).
...
scene_prior(shopfront, 1.29, 4.98).
...
scene_prior(skyscraper, 3.86, 1.7).
...
scene_prior(utility_room, 0.48, 4.02).
...
predict_emotion(CV, CA, FaceFeatures, SceneTensor, sadness) :-
    CV < 2.5, 
    CA < 3. 

predict_emotion(CV, CA, FaceFeatures, SceneTensor, Emotion) :-
    CV < 2.5, 
    CA >= 3, 
    get_negative_emotion(FaceFeatures, SceneTensor, Emotion). 

predict_emotion(CV, CA, FaceFeatures, SceneTensor, surprise) :-
    CV > 2.5, 
    CA >= 3.5. 
...
predict_emotion(CV, CA, FaceFeatures, SceneTensor, trust) :-
    CV > 2.5, 
    CA < 4. 

final_emotion(FaceFeatures, SceneTensor, Emotion) :-
    face_emotion(FaceFeatures, FaceEmotion),
